...
//                                     {item.title.substring(0,15)}...</h5>
//                             </div>
//                             <div className="card-body" >
//                                     <Link className="btn btn-dark m-1" to={"/products/" + item.id} >
//                                     Buy Now
//                                     </Link>
...
//         <div className="d-none d-md-black">
  ...
  return (
    <>
      <div className="container">
        {" "}
        {/* ✅ Fix 1 - claasName → className */}
        <div className="row">{loading ? <Loading /> : showProduct()}</div>
        <div className="row my-5 py-5">
          <div className="d-none d-md-block">
            {" "}
            {/* ✅ Fix 2 - d-md-black → d-md-block */}
